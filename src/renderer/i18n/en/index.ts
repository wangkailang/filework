...
const en: BaseTranslation = {
  ...
  memoryDebug_compressionCount: "Compression Count",
  memoryDebug_avgRatio: "Avg ratio {0:string}",
  memoryDebug_compressionSaved: "Compression Saved",
  memoryDebug_cacheHitCount: "Cache Hits",
