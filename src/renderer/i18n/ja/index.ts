...
const ja: Translation = {
  ...
  chat_emptyTitle: "このワークスペースで何を達成しますか？",
  chat_emptyDescription:
    "目標を説明してください。Workspace Agent がコンテキストを確認して実行します。",

  suggestion_gitExplain: "リポジトリの構成と主要なエントリーポイントを説明",
  suggestion_gitImplement: "機能を実装して変更を検証",
  suggestion_gitDiagnose: "失敗しているテストを診断して修正",
  suggestion_gitReview: "現在の変更をレビューしてリスクを指摘",
  suggestion_workspaceSummarize: "ワークスペースの構成と目的を要約",
  suggestion_workspacePlan: "目標を実行可能な計画に分解",
  suggestion_workspaceFind: "目標に関連するファイルとコンテキストを検索",
  suggestion_workspaceImprove: "ワークスペースをレビューして改善案を提示",
  ...
  telemetry_error: "エラー",
  cmdk_placeholder: "タスク、ファイル、操作を検索…",
  cmdk_empty: "一致するタスク、ファイル、操作がありません",
  cmdk_actions: "操作",
  cmdk_tasks: "タスク",
  cmdk_files: "ファイル",
  cmdk_searching: "ファイルを検索中…",
  ...
  settings_title: "設定",
  settings_groupPreferences: "環境設定",
  settings_groupCapabilities: "機能とセキュリティ",
  settings_groupDiagnostics: "診断",
  settings_toolWhitelist: "承認済みツール",
  settings_commandSecurity: "コマンドセキュリティ",
  settings_taskTrace: "タスクトレース",
  ...
  session_search: "タスクを検索",
  session_searchEmpty: "一致するタスクがありません",
  session_filter_label: "タスクを絞り込む",
  session_filter_all: "すべて",
  session_filter_attention: "要確認",
  session_filter_duplicates: "重複",
  session_filter_empty: "空",
  session_actions: "その他の操作",
  session_delete: "チャットを削除",
  session_newChat: "新しいチャット",
  session_rename: "名前を変更",
  session_group_attention: "要確認",
  ...
  chat_panelLabel: "タスク会話",
  chat_dropFiles: "ドロップしてファイルを添付",
  chat_workspaceGit: "Git リポジトリ",
  chat_workspaceLocal: "ローカルワークスペース",
  chat_branchContext: "ブランチ {0}",
  chat_attachFiles: "ファイルを添付",
  chat_send: "メッセージを送信",
  chat_stop: "生成を停止",
  chat_workspaceMemory: "ワークスペースメモリ",
  attachment_preview: "添付ファイル {0} をプレビュー",
  attachment_remove: "添付ファイル {0} を削除",
  attachment_reveal: "{0} を Finder に表示",
  subagent_delegation: "サブタスク委任",
  subagent_summary: "{0} 件 · 並列 {1} · 完了 {2}",
  subagent_usable: "利用可能 {0}/{1}",
  subagent_partialCount: "一部利用可能 {0}",
  subagent_truncatedCount: "切り詰め {0}",
  subagent_failedCount: "失敗 {0}",
  subagent_viewTrace: "「{0}」の実行過程を表示",
  subagent_steps: "{0} ステップ",
  subagent_statusQueued: "待機中",
  subagent_statusRunning: "実行中",
  subagent_statusOk: "完了",
  subagent_statusFailed: "失敗",
  subagent_statusCancelled: "キャンセル済み",
  subagent_statusTimeout: "タイムアウト",
  subagent_statusTokenLimit: "トークン上限",
  subagent_statusPartial: "一部利用可能",
  subagent_statusTruncated: "切り詰め済み",
  subagent_statusNoResult: "有効な結果なし",
  ...
  toolName_browserOpen: "ブラウザーで開く",
  toolName_browserTabs: "ブラウザータブ一覧",
  toolName_browserSwitchTab: "ブラウザータブ切替",
  toolName_browserSnapshot: "ブラウザーページを読む",
  toolName_browserClick: "ブラウザーでクリック",
  toolName_browserType: "ブラウザーで入力",
  toolName_browserPress: "ブラウザーでキー入力",
  toolName_browserScroll: "ブラウザーページをスクロール",
  toolName_browserClose: "ブラウザータブを閉じる",
  ...
  tool_webFetch_content: "ページ本文",
  tool_webFetch_empty: "表示できる本文を抽出できませんでした",
  tool_webFetch_truncated: "内容は省略されています",
  tool_webFetch_pages: "{0} ページ",
  tool_webFetch_matches: "{0} 件一致",
  tool_submit_complete: "完全な結果",
  tool_submit_partial: "部分的な結果",
  tool_submit_noResult: "結果なし",
  tool_submit_coverage: "調査範囲",
  tool_submit_findings: "主な発見",
  tool_submit_evidence: "補足証拠",
  tool_submit_missing: "未確認事項",
  tool_submit_failure: "未完了の理由",
  ...
  clarification_replyPlaceholder: "選択内容を説明…",
  clarification_send: "回答を送信",
