...
export const SettingsModal = ({
  ...
  return (
    ...
    >
      <DialogContent className="flex! flex-col gap-0! overflow-hidden bg-background! p-0! text-foreground! shadow-2xl w-[calc(100vw-64px)]! h-[calc(100vh-48px)]! max-w-[1200px]! max-h-[900px]!">
        <div
        ...
        >
          {/* Left sidebar tabs */}
          <div className="flex w-44 shrink-0 flex-col border-r border-border bg-muted/50 py-3">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              return (
                <button
          ...
          <div
            ...
            className="min-h-0 flex-1 overflow-y-auto py-5 pl-6 pr-14"
          >
            {activeTab === "general" && (
