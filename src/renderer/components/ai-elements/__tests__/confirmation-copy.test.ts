...
const makeLL = (locale: "en" | "zh"): TranslationFunctions =>
  ({
    ...
    toolName_browserClick: () => "browserClick",
    toolName_browserClose: () => "browserClose",
    toolName_browserOpen: () => "browserOpen",
    toolName_browserPress: () => "browserPress",
    toolName_browserScroll: () => "browserScroll",
    toolName_browserSnapshot: () => "browserSnapshot",
    toolName_browserSwitchTab: () => "browserSwitchTab",
    toolName_browserTabs: () => "browserTabs",
    toolName_browserType: () => "browserType",
